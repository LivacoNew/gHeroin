...
function ENT:Initialize()
	...
	self.health = gHeroin.Config.Entities.EntityHealth["acetic"]
end
...
function ENT:StartTouch(ent)
	...
	if(ent:GetClass() == "gheroin_barrel") then
		...
		if(ent:HasIngredient("acetic") == true) then return end
		if(ent:ReadyForIngredient("acetic") == false) then return end
		-- Register that it has Acetic in it, and remove the ent.
		ent:AddIngredient("acetic")
		self:Remove()
	end
end