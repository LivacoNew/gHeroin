...
function ENT:DrawTranslucent()
	...
	local textLength = surface.GetTextSize(gHeroin.Lang.Entities.Sodum3D2D) + 50

	cam.Start3D2D(pos, ang, 0.1)
	draw.RoundedBox(0, (textLength / 2) * -1, -25, textLength, 50, Color(0, 0, 0, 250))
	draw.SimpleText(gHeroin.Lang.Entities.Sodum3D2D, "gheroin.entities.1", 0, 0, Color(255, 255, 255, 255), 1, 1)
	cam.End3D2D()
end